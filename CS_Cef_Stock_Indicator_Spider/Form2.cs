...
namespace CS_Cef
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            String SQL = "SELECT * FROM main WHERE RSI_Golden_Cross>0 AND KD_Golden_Cross>0 ORDER BY RSI_Golden_Cross DESC,KD_Golden_Cross DESC";
            ...
            SQL = "SELECT * FROM main WHERE RSI_Death_Cross>0 AND KD_Death_Cross>0 ORDER BY RSI_Death_Cross DESC,KD_Death_Cross DESC";
